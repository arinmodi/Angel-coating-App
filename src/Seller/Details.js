...
import { AntDesign, MaterialIcons, FontAwesome } from '../Icons/icons'
...
export default function Details (props) {
  ...
  const gotoLoginScreen = () => {
    ...
    global.stackNavigator.dispatch(NavigationActions.navigate({ routeName : 'Login' , params : { Restart : true }}))
  };
      ...
      {loading === false ? (
            <View style = {{flex : 1}}>
               <View style={{ alignItems: 'center', marginTop: hp('5%') }}>
                ...
                <Text style = {{textAlign : 'center',marginBottom : hp('3%'),color : Primary,fontSize : hp('3%'),fontWeight : 'bold'}}> Code : {code}</Text>
